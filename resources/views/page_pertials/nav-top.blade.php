    ...
    <div class="container">
        <div class="d-flex header-nav">
            ...
            <div class="color-headerlogo">
                <a class="header-desktop" href="{{ route('admin_dashboard') }}"></a>
                <a class="header-mobile" href="{{ route('admin_dashboard') }}"></a>
            </div>
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
            <div class=" dropdown-header noti-title text-center border-bottom p-3">
                <div class="header-usertext">
                    <h5 class="mb-1">@if(Auth::user()->user_type == 'admin') Admin @else Customer @endif</h5>
